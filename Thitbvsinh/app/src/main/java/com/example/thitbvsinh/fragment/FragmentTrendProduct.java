...
import com.example.thitbvsinh.adapter.AdapterTrendProduct;
import com.example.thitbvsinh.item.Product;

import java.util.ArrayList;
import java.util.List;

public class FragmentTrendProduct extends Fragment {
    private List<Product> products;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.trend_product_fragment,container,false);
        return v;
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        AdapterTrendProduct adapterList = new AdapterTrendProduct(products,getContext());
        RecyclerView rc1 = (RecyclerView) getActivity().findViewById(R.id.rcl_trend);
