...
public class GridCalendarAdapter extends ArrayAdapter {
    ...
    public GridCalendarAdapter(@NonNull Context context, List<Date>dates,Calendar currentDate, List<Events>events) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (displaymonth==currentmonth && displayyear == currentyear){
            numberOfDay.setTextColor(getContext().getResources().getColor(R.color.layout_item_desc));
            //view.setBackgroundColor(getContext().getResources().getColor(R.color.white));
        }
        else{
            numberOfDay.setTextColor(Color.parseColor("#cccccc"));
