package com.t3h.myprojectnote.customview;
...
import com.t3h.myprojectnote.adapter.GridCalendarAdapter;
...
//    String[] datetoday = simpleDateFormat.format(calendar.getTime()).split(",");
    ...
    private void setUpCalendar() {
        ...
        int fistDayOfMonth = monthCalendar.get(Calendar.DAY_OF_WEEK)-1;
        monthCalendar.add(Calendar.DAY_OF_MONTH,-fistDayOfMonth);
        while (dates.size()<MAX_CALENDAR_DAYS){
            dates.add(monthCalendar.getTime());
            monthCalendar.add(Calendar.DAY_OF_MONTH,1);
        }
        mygridAdapter = new GridCalendarAdapter(context,dates,calendar,events);
