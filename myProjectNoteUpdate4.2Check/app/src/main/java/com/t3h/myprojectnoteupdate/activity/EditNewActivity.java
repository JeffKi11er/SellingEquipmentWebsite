...
public class EditNewActivity extends AppCompatActivity implements AppConstants {
...
//    boolean band = true;
    ...
    private void init() {
        final Date dateConvert = AppUtils.getCurrentDateTime();
        ...
        btndone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (item!=null){
                    ...
                    item.setModifiedAt(dateConvert);
                    intent.putExtra(INTENT_TASK,item);
                }else {
...
//                    String []dayT = AppUtils.getFormattedDayString(AppUtils.getCurrentDateTime()).split(" ",3);
                    String day = Integer.toString(dateConvert.getDate());
                    String month = Integer.toString(dateConvert.getMonth());
                    String year  =Integer.toString(dateConvert.getYear());
                    String hours = Integer.toString(dateConvert.getHours());
                    String minus = Integer.toString(dateConvert.getMinutes());
...
//            NavigatorUtils.redirectToMenuSettingNote(this,item);
        ...
        imgDetail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String date = AppUtils.getFormattedTimeStringMenu(dateConvert);
        ...
        if (item == null) {
            ...
            tvdate.setText(AppUtils.getFormattedTimeStringMenu(dateConvert));
        } else {
            ...
            if (item.getCreatedAt() != null) {
                tvdate.setText(AppUtils.getFormattedTimeStringMenu(item.getCreatedAt()));
            }
        }
